...
In NPE,
$\phi_1 = NN(\mathcal{D}), \phi_i = NN(\theta_{1:i-1}, \mathcal{D}), 1 < i < D$.
In NLE,
$\phi_1 = NN(\theta),\phi_i = NN(\mathcal{D}_{1:i-1}, \theta), 1 < i < D$
...
such case although there would be no 'coupling' anymore. For example in
